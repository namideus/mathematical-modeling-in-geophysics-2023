...
Psi = (C_1.*exp(A.*xx)+C_2.*exp(B.*xx)+D_1.*cos(r_l.*xx)+D_2.*sin(r_l.*xx)).*sin(q_m.*yy)
+ (C_1_bar.*exp(A_bar.*xx)+C_2_bar.*exp(B_bar.*xx)+D_1_bar.*cos(r_s.*xx) + D_2_bar.*sin(r_s.*xx)).*sin(q_p.*yy);
